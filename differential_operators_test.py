...
def differentialA(L, nu, nx, typeODE, v):
    ...
    # nu           - diffusion coefficient of Burgers' or advection diffusion equation
    # nx           - spatial degrees of freedom
    # typeODE      - type of solving ODE
    # v            - advection speed of advection diffusion equation
    #
    # Output:
    # returns the discretized right-hand side F of ODE
    # Burgers' equation: u_t = -uu_x + nu*u_xx with nonstiff part f_E = -uu_x and stiff part f_I = vu_xx
    # advection diffusion equation: u_t = -v*u_x + nu*u_xx
